...
└── cmd/
    └── omega/                # single binary: serve, run, health, chat; /new --ephemeral, /sessions (table, delete, resume by #/label/id), /tree (table), /copy, /thinking, /tools, /extensions
```
...
| `cmd/omega/`        | Implemented | Single binary: serve, run, health, chat; /new --ephemeral, /sessions (table, delete, resume by #/label/id), /tree (table), /copy, /thinking, /tools, /extensions                                                                                                         |
