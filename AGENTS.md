...
| `cmd/omega/`        | Implemented | Single binary: serve, run, health, chat; /new --ephemeral, /sessions (table, delete, resume by #/label/id), /tree (table), /copy, /export, /thinking, /tools, /extensions, /skills, /models, /model (number or name)                                                     |
