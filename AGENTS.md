...
| `internal/ai/`      | Implemented | Provider abstraction, stream events, message + tool types, retry, multi-provider, API key auth (Ollama Cloud, OpenAI, Anthropic), HTTP timeout (OMEGA_HTTP_TIMEOUT)                                                                                                                                                                                                                                                            |
