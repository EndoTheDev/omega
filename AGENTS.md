...
| `bin/extensions/` | Reference   | Extension authoring guide (README.md), core-prompt extension (system prompt builder), core-provider extension (LLM provider streaming: Ollama, OpenAI, Anthropic), core tools extension, web search extension, MCP bridge, and skill templates                                                                                                                                                                                       |     |
